...
runs = 10
minindex = 0
Benchmark_modes = ["ECCC-MADRL","MADDPG-DL", "MADDPG-SHORT", "MADDPG"]# "mindeadlinefirst_MADDPG",  "maxdeadlinefirst_MADDPG",  "minsizefirst_MADDPG", "maxsizefirst_MADDPG",  "offloadtimefirst_MADDPG", "vanilla_MADDPG"]
